...
class MerchantsControllerTest < ActionController::TestCase
  ...
  test "should create merchant" do
    assert_difference('Merchant.count') do
      post :create, merchant: { address: @merchant.address, contact: @merchant.contact, name: @merchant.name, note: @merchant.note, url: @merchant.url }
    end
  ...
  test "should update merchant" do
    put :update, id: @merchant, merchant: { address: @merchant.address, contact: @merchant.contact, name: @merchant.name, note: @merchant.note, url: @merchant.url }
    assert_redirected_to merchant_path(assigns(:merchant))
  end
