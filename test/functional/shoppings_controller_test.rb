...
class ShoppingsControllerTest < ActionController::TestCase
  ...
  test "should create shopping" do
    assert_difference('Shopping.count') do
      post :create, shopping: { account_id: @shopping.account_id, amount: @shopping.amount, bill_number: @shopping.bill_number, date: @shopping.date, merchant_id: @shopping.merchant_id }
    end
  ...
  test "should update shopping" do
    put :update, id: @shopping, shopping: { account_id: @shopping.account_id, amount: @shopping.amount, bill_number: @shopping.bill_number, date: @shopping.date, merchant_id: @shopping.merchant_id }
    assert_redirected_to shopping_path(assigns(:shopping))
  end
